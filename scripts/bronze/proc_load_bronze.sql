...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> Load Duration: ' + CAST(DATEDIFF_BIG(millisecond, @start_time, @end_time) AS NVARCHAR) + ' milliseconds';
		PRINT '>> -------------';
        ...
        PRINT '   - Total Load Duration: ' + CAST(DATEDIFF_BIG(millisecond, @batch_start_time, @batch_end_time) AS NVARCHAR) + ' milliseconds';
		PRINT '=========================================='
	END TRY
	BEGIN CATCH
		PRINT '=========================================='
